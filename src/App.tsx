...
import { faBullhorn, faSearch, faChevronUp, faPaperPlane, faQuestionCircle, faCheck, faUser, faBolt, faCommentDots, faStickyNote, faPhoneSlash, faStar, faTimesCircle, faTags, faHeadset, faMobileAlt, faShare, faBell, faLayerGroup } from '@fortawesome/free-solid-svg-icons';

library.add(fab, faBullhorn, faSearch, faChevronUp, faPaperPlane, faQuestionCircle, faCheck, faUser, faBolt, faCommentDots, faStickyNote, faPhoneSlash, faStar, faTimesCircle, faTags, faHeadset, faMobileAlt, faShare, faBell, faLayerGroup);
